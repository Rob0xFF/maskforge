...
> The PNG files generated by this toolkit are **intermediate photomasks**. To actually display them on your LCD exposure hardware, i.e. M-SLA 3D printer, you must pass them through **PCBTools** (or an equivalent injection utility) that knows how to inject image frames to your specific printer files.\
